...
var
    msgstart = "started downloading now ...",
...
function downAudio() {
    ...
    ffmpeg(stream)
        ...
        .on('end', () => {
            ...
            status1.value = "Audio saved to " + `${app.getPath('home')}/Downloads/${name}.mp3`;
...
reload.addEventListener('click', goRefresh);